...
import static com.example.mobileproject.R.*;
...
public class SimilarRecipeAdapter extends RecyclerView.Adapter<SimilarRecipeViewHolder>{
    ...
    public SimilarRecipeAdapter(RecipeClickListener listener, List<SimilarRecipeResponse> list, Context context) {
    ...
    public SimilarRecipeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new SimilarRecipeViewHolder(LayoutInflater.from(context).inflate(layout.list_similar_recipe, parent, false));
    }
